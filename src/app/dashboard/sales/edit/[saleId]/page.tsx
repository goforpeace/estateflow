...
import { collection, doc, writeBatch, query, where, getDoc, updateDoc } from 'firebase/firestore';
...
export default function EditSalePage() {
  ...
  const saleRef = useMemoFirebase(() => saleId ? doc(firestore, 'sales', saleId) : null, [firestore, saleId]);
  const { data: sale, isLoading: saleLoading, error } = useDoc<Sale>(saleRef);
  ...
  return (
    <Card>
        <CardHeader>
            ...
            <CardDescription>Update the details for this sale transaction.</CardDescription>
        </CardHeader>
        <CardContent>
            <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="flex justify-end pt-4">
                    <Button type="submit" disabled={form.formState.isSubmitting || projectsLoading || customersLoading || flatsLoading || saleLoading}>
